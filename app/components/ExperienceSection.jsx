    ...
    <div 
      ...
      <div className="hero-content flex-col lg:flex-row-reverse">
        <div>
          ...
          <p className="text-[#294457] text-lg lg:mt-2">Surrounded by talented developers, gained valuable experience while contributing to the solutions. The experience solidified my passion for web development, and I am eager to see where this path takes me next.</p>
        </div>
        <img
